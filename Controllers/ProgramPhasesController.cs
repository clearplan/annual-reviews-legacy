...
{
    public class ProgramPhasesController : Controller
    {
        private readonly ReviewContext _context;

        public ProgramPhasesController(ReviewContext context)
        {
            _context = context;
        }
        ...
        // GET: ProgramPhases/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProgramPhases/Create
