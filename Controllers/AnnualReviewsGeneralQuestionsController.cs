...
{
    public class AnnualReviewsGeneralQuestionsController : Controller
    {
        private readonly ReviewContext _context;

        public AnnualReviewsGeneralQuestionsController(ReviewContext context)
        {
            _context = context;
        }

        // GET: AnnualReviewsGeneralQuestions
        public async Task<IActionResult> Index()
        {
            return View(await _context.TblAnnualReviewGeneralQuestions.ToListAsync());
        }

        // GET: AnnualReviewsGeneralQuestions/Details/5
        ...
        // GET: AnnualReviewsGeneralQuestions/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AnnualReviewsGeneralQuestions/Create
        ...
        // GET: AnnualReviewsGeneralQuestions/Edit/5
        ...
        // POST: AnnualReviewsGeneralQuestions/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AnnualReviewsGeneralQuestions/Delete/5
        ...
        // POST: AnnualReviewsGeneralQuestions/Delete/5
